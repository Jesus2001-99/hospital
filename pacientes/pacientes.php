...
<header id="menu" class="">
    ...
    <div class="">
        <form action="#" class="form" method="POST">
                    <div class="buscar">
                        <input type="search" name="dato" placeholder="Nombre del paciente" class="" autocomplete="off">
                    ...
                    <tbody>
                        <?php 
                                if (isset($_POST['buscar'])) {
                                    ...
                                    $dato=$_POST['dato'];
                                    $query="SELECT * FROM paciente WHERE Nombre_paciente LIKE '$dato%'";
                                    $resultado=$conexion->query($query);
                                    while ($fila=$resultado->fetch_assoc()) {
                                        $id=$fila['ID_paciente']; 
                                     ?>
                        <tr class='text-center'>
                            <td><small><?php echo $fila['ID_paciente']; ?></small></td>
                            <td><small><?php echo $fila['CURP_paciente']; ?></small></td>
                            <td><small><?php echo $fila['Nombre_paciente']; ?></small></td>
                            <td><small><?php echo $fila['Apellido_paciente']; ?></small></td>
                            <td><small><?php echo $fila['Telefono_paciente']; ?></small></td>
                            <td><small><?php echo $fila['Direccion_paciente']; ?></small></td>
                            <td><small><?php echo $fila['Sexo_paciente']; ?></small></td>
                            <td><small><?php echo $fila['Historial_paciente']; ?></small></td>
                            <td><small><?php echo $fila['FechaNac_paciente']; ?></small></td>
                            <td><small><?php echo $fila['Correo_paciente']; ?></small></td>
                            <td><small><?php echo $fila['Usuario_paciente']; ?></small></td>
                            <td><small>*******</small></td>
                            <td><a class="" href="modificar_pacientes.php?id=<?php echo $fila['ID_paciente'] ?>"><span class='icofont-ui-edit'></small></a></td>
